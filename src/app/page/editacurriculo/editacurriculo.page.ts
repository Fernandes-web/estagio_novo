...
export class EditacurriculoPage implements OnInit {
      ...
      this.afs.firestore
        ...
        .then((uData) => {
          ...
          if (uData.exists) {
            ...
            this.registerForm.controls.escolaridade.setValue(this.userData.escolaridade);
            this.registerForm.controls.experiencias.setValue(this.userData.experiencias);
          }
        });
    }
  }
  ...
  registerFormCreate() {
    ...
    this.registerForm = this.form.group({
      ...
      // Campo endereço (address)
      experiencias: ['', Validators.compose([Validators.required])],
    });
  }
